...
handlePasswordChange('staff', 'portal/staff/settings.php');
$pageTitle = 'Settings';
require_once __DIR__ . '/../../includes/header.php';
?>
<section class="page-header"><div><h1>Settings</h1><p class="page-subtitle">Update your staff account password.</p></div></section>
<section class="card" style="max-width:560px;">
    <form method="post" action="<?= e(appPath('portal/staff/settings.php')) ?>">
        <?= CSRF::field() ?>
